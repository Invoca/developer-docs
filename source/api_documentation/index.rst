...
The Transactions API and Network Integration API are accessible using the API credentials generated on the platform. See `Manage API Credentials <manage_api_credentials.html>`_ for more information.

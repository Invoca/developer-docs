...
def source_handler(app, docname, source):
  ...
  def build_collapsed_div(match):
    match = match.group()
    lines = match.splitlines()
    lines.pop(0) # remove ".. api_endpoint::" line
    template_vars = {}
    for line in lines:
  ...
  source[0] = re.sub(re.compile("\.\. api_endpoint::.*?$.^$(.^ +:.*?$)+", re.MULTILINE | re.DOTALL), build_collapsed_div, source[0])
...
def setup(app):
  ...
  app.add_javascript('https://cdnjs.cloudflare.com/ajax/libs/highlight.js/8.5/highlight.min.js')
  app.add_stylesheet('css/custom.css')
  app.add_stylesheet('https://cdnjs.cloudflare.com/ajax/libs/highlight.js/8.5/styles/github.min.css')

...
def setup(app):
  ...
  app.add_js_file('js/swagger-ui/swagger-initializer.js')
  app.add_js_file('js/swagger-ui/swagger-ui-bundle.js')
  app.add_js_file('js/swagger-ui/swagger-ui-bundle.js.map')
  ...
  app.add_css_file('css/swagger-ui/index.css')
  app.add_css_file('css/swagger-ui/swagger-ui.css')
  app.add_css_file('css/swagger-ui/swagger-ui.css.map')
